...
var file_calculator_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x44,
...
var file_calculator_proto_goTypes = []interface{}{
	...
	nil,                           // 3: service.Person.CountriesEntry
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(Gender)(0),                   // 5: service.Gender
}
var file_calculator_proto_depIdxs = []int32{
	4, // 0: service.HelloRequest.created_date:type_name -> google.protobuf.Timestamp
	5, // 1: service.Person.gender:type_name -> service.Gender
	3, // 2: service.Person.countries:type_name -> service.Person.CountriesEntry
	4, // 3: service.Person.created_date:type_name -> google.protobuf.Timestamp
	0, // 4: service.Calculator.Hello:input_type -> service.HelloRequest
	1, // 5: service.Calculator.Hello:output_type -> service.HelloResponse
